...
export function StudyIcon({ className = '', size = 12 }: IconProps) {
    return (
        <svg
            width={size}
            height={size}
...
export function PracticeIcon({ className = '', size = 12 }: IconProps) {
    return (
        <svg
            width={size}
            height={size}
...
export function BuildIcon({ className = '', size = 12 }: IconProps) {
    return (
        <svg
            width={size}
            height={size}
...
export function ReviewIcon({ className = '', size = 12 }: IconProps) {
    return (
        <svg
            width={size}
            height={size}
...
export function ExploreIcon({ className = '', size = 12 }: IconProps) {
    return (
        <svg
            width={size}
            height={size}
